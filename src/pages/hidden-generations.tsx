...
export default function HiddenGenerationsPage() {
  ...
  if (isLoading) {
    return (
      <View height="100vh" align="center" justify="center" attributes={{ style: { width: `calc(100% - ${NAV_WIDTH}px)` } }}>
        <Loader />
      </View>
    );
  }
  ...
  if (error) {
    return (
      <View height="100vh" padding={4} attributes={{ style: { width: `calc(100% - ${NAV_WIDTH}px)` } }}>
